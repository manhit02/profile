...
const translations = {
  vi: {
    ...
    projects: {
      ...
      ausquad: "AuSQUAD",
      ausquadDesc: "Website cộng đồng game thủ với giao diện hiện đại",
      matlenh: "Mật lệnh",
      matlenhDesc: "Ứng dụng truyền thông điệp bí mật với mã hóa an toàn",
      matlenhstore: "Mật lệnh Store",
      matlenhstoreDesc: "Cửa hàng trực tuyến tích hợp hệ thống Mật lệnh",
      au2: "Au2",
      au2Desc: "Nền tảng giải trí trực tuyến thế hệ mới",
      beapro: "Beapro",
      beaproDesc: "Website dịch vụ chuyên nghiệp với trải nghiệm người dùng tối ưu",
      phuckich: "Phục Kích",
      phuckichDesc: "Trang chủ game bắn súng đình đám với hiệu ứng ấn tượng",
      truykick: "Truy Kích",
      truykickDesc: "Website game hành động với thiết kế sống động",
      truykickhome: "Truy Kích Home",
      truykickhomeDesc: "Trang chủ chính thức của game Truy Kích",
  ...
  en: {
    ...
    projects: {
      ...
      ausquad: "AuSQUAD",
      ausquadDesc: "Gaming community website with modern interface",
      matlenh: "Mat Lenh",
      matlenhDesc: "Secret messaging app with secure encryption",
      matlenhstore: "Mat Lenh Store",
      matlenhstoreDesc: "Online store integrated with Mat Lenh system",
      au2: "Au2",
      au2Desc: "Next-generation online entertainment platform",
      beapro: "Beapro",
      beaproDesc: "Professional services website with optimized user experience",
      phuckich: "Phuc Kich",
      phuckichDesc: "Popular shooter game homepage with impressive effects",
      truykick: "Truy Kich",
      truykickDesc: "Action game website with vibrant design",
      truykickhome: "Truy Kich Home",
      truykickhomeDesc: "Official homepage of Truy Kich game",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                {
                  name: t.projects.ausquad,
                  url: "https://lighthearted-haupia-ba4e05.netlify.app/",
                  desc: t.projects.ausquadDesc,
                  color: "from-cyan-400 to-blue-600",
                },
                {
                  name: t.projects.matlenh,
                  url: "https://profound-tanuki-19bea8.netlify.app/",
                  desc: t.projects.matlenhDesc,
                  color: "from-slate-500 to-gray-700",
                },
                {
                  name: t.projects.matlenhstore,
                  url: "https://celadon-lokum-d47c79.netlify.app/",
                  desc: t.projects.matlenhstoreDesc,
                  color: "from-teal-400 to-cyan-600",
                },
                {
                  name: t.projects.au2,
                  url: "https://shimmering-lily-e0af0b.netlify.app/",
                  desc: t.projects.au2Desc,
                  color: "from-yellow-400 to-orange-500",
                },
                {
                  name: t.projects.beapro,
                  url: "https://fanciful-licorice-e22cb9.netlify.app/",
                  desc: t.projects.beaproDesc,
                  color: "from-emerald-400 to-green-600",
                },
                {
                  name: t.projects.phuckich,
                  url: "https://taupe-sunshine-432419.netlify.app/",
                  desc: t.projects.phuckichDesc,
                  color: "from-red-500 to-rose-700",
                },
                {
                  name: t.projects.truykick,
                  url: "https://soft-lokum-ee23ce.netlify.app/#trangdau",
                  desc: t.projects.truykickDesc,
                  color: "from-indigo-500 to-purple-700",
                },
                {
                  name: t.projects.truykickhome,
                  url: "https://effortless-lebkuchen-f5f42f.netlify.app/",
                  desc: t.projects.truykickhomeDesc,
